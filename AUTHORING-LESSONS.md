...
- **Observability simulator:** `generate()` returns realistic logs (question,
  ...
  drift on day 16; it actually started on day 14 — 2-day lag." A `quality=0.6` field
