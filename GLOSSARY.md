...
cannot decide which checks were needed. *(Testing & Delivery §2)*
...
its generator, seed, first failure, and shrunk witness. *(Testing & Delivery §4)*
...
model behavior, never carry the test's expected answer. *(Testing & Delivery §5)*
...
not bit for bit. *(Testing & Delivery §6)*
...
zero-based index; conflating them is the classic p95 bug. *(Testing & Delivery §6)*
...
cannot prove the lower bound. *(Testing & Delivery §10)*
...
user is exposed. *(Testing & Delivery §12)*
